...
humandate: "Feb 6–14, 2024"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "12:00 pm - 2:00 pm ET (R & Git), 12:00 pm - 3:00 pm ET (Python & Unix Shell)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Dan Carver", "Sarah Hettema", "Olivia Landry", "Kenton Ross", "Mara Sedlins", "Lisa Tanh", "Kevin Worthington"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Truman Anarella", "Cecil Byles", "Katie Caruso", "Maya Hall", "Paxton LaJoie", "Isabel Lubitz", "Sean McCartney", "Michael Pazmino", "Laramie Plott", "Megan Rich", "Marisa Smedsrud", "Chanda Trivedi", "Lauren Webster", "Stephanie Willsey", "Jane Zugarek"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["sean.mccartney@nasa.gov", "kenton.w.ross@nasa.gov", "laramie.d.plott@nasa.gov", "carver.dan1@gmail.com"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
